...
case1_step1 = {
    "step1": [
        f"export cardid=0&&tupleacl --add --sip {pcap_sip} --action forward --netlbl strip --drop on --match n --mode BLP --doi 16 --level 10 --type 1 --value 0x3,0,0,0",
        f"tupleacl --query --sip {pcap_sip}", pcap_sip]
}
case1_step2 = {
    "step1": [
        f"tupleacl --clear&&tupleacl --add --sip {pcap_sip} --action forward --netlbl strip --drop on --match n --mode BLP --doi 16 --level 16 --type 1 --value 0x3,0,0,0",
        f"tupleacl --query --sip {pcap_sip}", pcap_sip]
}
...
case3_step1 = {
    "step1": [
        f"export cardid=0&&tupleacl --add --sip {pcap_sip} --action forward --netlbl strip --drop on --match n --mode BIBA --doi 16 --level 16 --type 1 --value 0x3,0,0,0",
        f"tupleacl --query --sip {pcap_sip}", pcap_sip]
}
case3_step2 = {
    "step1": [
        f"tupleacl --clear&&tupleacl --add --sip {pcap_sip} --action forward --netlbl strip --drop on --match n --mode BIBA --doi 16 --level 10 --type 1 --value 0x3,0,0,0",
        f"tupleacl --query --sip {pcap_sip}", pcap_sip]
}
