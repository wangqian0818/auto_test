...
class Test_acl_drop():
    ...
    def test_acl_drop_a2(self):
        ...
        # 初始化
        cap_iface, cap_filter, cap_num, cap_pcap1, cap_pcap2, cap_pcap3 = self.pkt2_cfg["capture"][0], \
                                                                          self.pkt2_cfg["capture"][1], \
                                                                          self.pkt2_cfg["capture"][2], \
                                                                          self.pkt2_cfg["capture"][3], \
                                                                          self.pkt2_cfg['capture'][4], \
                                                                          self.pkt2_cfg['capture'][5]
