...
# 隔离设备端的设置
BG8010['front_dut', 'manageIp'] = "10.10.101.13"  # 隔离测试前置机管理IP
BG8010['front_dut', 'loginUser'] = "root"  # 登录账户
BG8010["front_dut", "loginPwd"] = "1q2w3e"  # 登录密码
BG8010["front_dut", "operationIp"] = "192.168.30.13"  # 设备间通信用的业务IP
BG8010["front_dut", "operationIfname"] = "enp60s0f01"  # 设备接口名
BG8010["front_dut", "operationNum"] = "2"  # 该业务ip所在的接口号，从1开始排序
BG8010["front_dut", "domain"] = "hf.f1203.g01.cs_17.wg13"  # 前置机domain
BG8010["front_dut", "cardid"] = "CS807304LV200A1N015"  # 安全卡的网卡序列号

BG8010['back_dut', 'manageIp'] = "10.10.101.14"  # 隔离测试后置机管理IP
BG8010['back_dut', 'loginUser'] = "root"  # 登录账户
BG8010["back_dut", "loginPwd"] = "1q2w3e"  # 登录密码
BG8010["back_dut", "operationIpInside"] = "192.168.50.14"  # 设备间通信用的业务IP
BG8010["back_dut", "operationIfnameInside"] = "enp60s0f00"  # 设备接口名
BG8010["back_dut", "operationIpOutside"] = "10.10.101.14"  # 设备间通信用的业务IP
BG8010["back_dut", "operationIfnameOutside"] = "enp60s0f12"  # 设备接口名
BG8010["back_dut", "domain"] = "hf.f1203.g01.cs_17.wg14"  # 后置机domain
BG8010["back_dut", "cardid"] = "CS807304LV200A1N009"  # 安全卡的网卡序列号
