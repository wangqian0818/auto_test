...
"step10": [r"cat /usr/local/nginx/lua/http.lua | grep =\{ | grep -v local", get1_data1],
"step11": [r"cat /usr/local/nginx/lua/http.lua | grep =\{ | grep -v local", get1_data2],
"step12": [r"cat /usr/local/nginx/lua/http.lua | grep =\{ | grep -v local", post1_data1],
"step13": [r"cat /usr/local/nginx/lua/http.lua | grep =\{ | grep -v local", post1_data2],
"step14": [r"cat /usr/local/nginx/lua/http.lua | grep =\{ | grep -v local", check1_uri1],
"step15": [r"cat /usr/local/nginx/lua/http.lua | grep =\{ | grep -v local", check1_uri2]
}
