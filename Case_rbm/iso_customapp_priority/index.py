...
priority1 = 'ruler action="allow"'
priority2 = 'ruler action="deny"'
...
case1_step1={
"step1":["cat /etc/jsac/custom_app.xml",priority1],
}
...
case2_step1={
"step1":["cat /etc/jsac/custom_app.xml",priority2],
}
case2_step2={
"step1":["netstat -anp |grep tcp",app_ip],
}
