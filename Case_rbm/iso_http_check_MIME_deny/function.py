'''
脚本一：
用例名称：验证隔离策略下基于一种MIME类型设置阻断的网页访问策略
编写人员：李皖秋
编写日期：2021.7.9
测试目的：验证隔离策略下基于一种MIME类型设置阻断的网页访问策略
测试步骤：
1、下发http的隔离策略：代理ip为前置机安全卡的ip，port为2287，等待nginx的24个进程起来
2、下发http的MIME黑名单，参数为：pdf，等待nginx的24个进程起来
3、控制台发送get请求，不包含请求内容
4、控制台发送get请求，请求内容不包含MIME黑名单
5、控制台发送get请求，请求内容包含MIME黑名单：pdf
...
2、cat /etc/jsac/http.json文件应该包含：s_content_type和MIME黑名单参数：pdf
...
脚本二：
用例名称：验证隔离策略下基于多种MIME类型设置阻断的网页访问策略
编写人员：李皖秋
编写日期：2021.7.12
测试目的：验证隔离策略下基于多种MIME类型设置阻断的网页访问策略
测试步骤：
1、下发http的隔离策略：代理ip为前置机安全卡的ip，port为2287，等待nginx的24个进程起来
2、下发http的MIME黑名单，参数为：js、mps、gif、tsv、avi，等待nginx的24个进程起来
3、控制台发送get请求，不包含请求内容
4、控制台发送get请求，请求内容不包含MIME黑名单
5、控制台发送get请求，请求内容包含MIME黑名单：js
6、控制台发送get请求，请求内容包含MIME黑名单：mps
7、控制台发送get请求，请求内容包含MIME黑名单：gif
8、控制台发送get请求，请求内容包含MIME黑名单：tsv
9、控制台发送get请求，请求内容包含MIME黑名单：avi
10、移除http的隔离策略，清空环境，等待nginx的24个进程起来
11、移除网页访问策略，等待nginx的24个进程起来
预期结果：
1、cat /etc/jsac/http.stream应该包含代理ip和port，且netstat -anp |grep tcp应该可以查看到监听ip和端口
2、cat /etc/jsac/http.json文件应该包含：s_content_type和MIME黑名单参数：js、mps、gif、tsv、avi
3、请求成功，请求到的内容为server的index.html文件内包含的内容
4、请求失败，状态码返回为200
5、请求成功，状态码返回为403
6、请求成功，状态码返回为403
...
脚本三：
用例名称：验证隔离下基于所有MIME类型设置阻断的网页访问策略
编写人员：李皖秋
编写日期：2021.7.12
测试目的：验证隔离下基于所有MIME类型设置阻断的网页访问策略
测试步骤：
1、下发http的隔离策略：代理ip为前置机安全卡的ip，port为2287，等待nginx的24个进程起来
2、下发http的MIME黑名单，参数为：所有MIME类型，等待nginx的24个进程起来
3、控制台发送get请求，不包含请求内容
4、控制台发送get请求，请求内容包含MIME黑名单：doc
5、控制台发送get请求，请求内容包含MIME黑名单：js
6、控制台发送get请求，请求内容包含MIME黑名单：mps
7、控制台发送get请求，请求内容包含MIME黑名单：gif
8、控制台发送get请求，请求内容包含MIME黑名单：tsv
...
print(base_path)
try:
    from iso_http_check_MIME_deny import index
    from iso_http_check_MIME_deny import message
...
class Test_iso_http_check_MIME_deny():
    ...
    def test_iso_http_check_MIME_deny_a1(self):
        ...
        # 数据检查
        print('2、下发http的MIME黑名单，参数为：pdf，等待nginx的24个进程起来;预期cat /etc/jsac/http.json文件应该包含：s_content_type和MIME黑名单参数：pdf')
        ...
        print('4、控制台发送get请求，请求内容不包含MIME黑名单；请求成功，状态码返回为200')
        ...
        print('5、控制台发送get请求，请求内容包含MIME黑名单：pdf；请求失败，状态码返回为403')
    ...
    def test_iso_http_check_MIME_deny_a2(self):
        ...
        # 数据检查
        print('2、下发http的MIME黑名单，参数为：js、mps、gif、tsv、avi，等待nginx的24个进程起来;cat /etc/jsac/http.json文件应该包含：s_content_type和MIME黑名单参数：js、mps、gif、tsv、avi')
        ...
        print('5、控制台发送get请求，请求内容包含MIME黑名单：js；请求失败，状态码返回为403')
        ...
        print('6、控制台发送get请求，请求内容包含MIME黑名单：mps；请求失败，状态码返回为403')
        ...
        print('7、控制台发送get请求，请求内容包含MIME黑名单：gif；请求失败，状态码返回为403')
        ...
        print('8、控制台发送get请求，请求内容包含MIME黑名单：tsv；请求失败，状态码返回为403')
        ...
        print('9、控制台发送get请求，请求内容包含MIME黑名单：avi；请求失败，状态码返回为403')
    ...
    def test_iso_http_check_MIME_deny_a3(self):
        ...
        # 数据检查
        print('2、下发http的MIME黑名单，参数为：所有MIME类型，等待nginx的24个进程起来;cat /etc/jsac/http.json文件应该包含：s_content_type和MIME所有类型')
        ...
        # 发送get请求，请求内容包含MIME黑名单
        print('4、控制台发送get请求，请求内容包含MIME黑名单：doc；请求失败，状态码返回为403')
        status_code = http_check.http_get(self.base_uri, self.data, flag=1)
        print('get请求内容包含MIME黑名单返回的状态码为：{}'.format(status_code))
        assert status_code == 403
