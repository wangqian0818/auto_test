...
print(base_path)
try:
	from iso_http_check_get_post_uri_MIME import index
	from iso_http_check_get_post_uri_MIME import message
...
class Test_iso_http_check_get_post_uri_MIME ():
	...
	def test_iso_http_check_get_post_uri_MIME_a1(self):
		...
		# 数据检查
		print('2、下发http的get黑名单，参数为：hello、juson；post黑名单：123、456；uri黑名单：mzh、hkl；MIME白名单：css、avi，等待nginx的24个进程起来;预期cat /etc/jsac/http.json文件应该包含：c_get_args和get黑名单参数：123')
		...
		print('15、控制台发送post请求，请求内容包含get黑名单hello；请求成功，请求到的内容为server的index.html文件内包含的内容')
		...
		print('17、控制台发送get请求，请求内容包含MIME白名单css；请求成功，状态码返回为200')
		...
		print('18、控制台发送get请求，请求内容包含MIME白名单avi；请求成功，状态码返回为200')
		...
		print('19、控制台发送get请求，请求内容包含MIME类型但不在其白名单：pdf；请求失败，状态码返回为403')
		...
		print('20、控制台发送get请求，请求内容包含MIME白名单：css和get黑名单：juson；请求失败，状态码返回为403')
		...
		print('21、控制台发送get请求，请求内容包含MIME白名单：avi和post黑名单：123；请求成功，状态码返回为200')
		...
		# 移除策略，还原环境
		print('22、移除代理策略，清空环境，等待nginx的24个进程起来;netstat -anp |grep tcp应该查看不到监听ip和端口')
		...
		# 检查网页访问策略是否清空
		print('23、移除网页访问策略，等待nginx的24个进程起来;cat /etc/jsac/http.json文件应该不包含：http协议')
	...
	def test_iso_http_check_get_post_uri_MIME_a2(self):
		...
		# 数据检查
		print('2、下发http的get黑名单，参数为：hello、juson；post黑名单：123、456；uri黑名单：mzh、hkl；MIME黑名单：css、avi，等待nginx的24个进程起来;预期cat /etc/jsac/http.json文件应该包含：c_get_args和get黑名单参数：123')
		...
		print('21、控制台发送get请求，请求内容包含MIME类型但不在黑名单：pdf和get黑名单：hello；请求失败，状态码返回为403')
