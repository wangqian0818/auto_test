...
smtp_keyfile = 'cat /etc/jsac/key_word/kw1_' + str(mail_port)
pop3_keyfile = 'cat /etc/jsac/key_word/kw1_' + str(pop3_proxy_port)
ftp_keyword = 'RETR'
ftp_keyfile = 'cat /etc/jsac/key_word/kw1_' + str(ftp_proxy_port)
