...
print(base_path)
try:
	from iso_ftp_up_down import index
	from iso_ftp_up_down import message
...
class Test_iso_ftp_up_down():
    ...
    def test_iso_ftp_up_down_a3(self):
        ...
        # print('ftp走隔离上传一个100M大小的文件结果为:{}'.format(self.uplocalPath, result))
        # assert result == 1
